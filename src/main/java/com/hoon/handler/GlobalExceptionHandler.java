package com.hoon.handler;

import com.hoon.common.exception.ErrorMessage;
import com.hoon.common.exception.GlobalException;
...
public class GlobalExceptionHandler {
    ...
    protected ResponseEntity<ErrorMessage> handleHttpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException e, HttpServletRequest request) {
        ...
        ErrorMessage em = ErrorMessage.builder()
                ...
                .build()
                ;
        return  new ResponseEntity<ErrorMessage>(em, HttpStatus.METHOD_NOT_ALLOWED);
    }
    ...
    protected ResponseEntity<ErrorMessage> handleAccessDeniedException(AccessDeniedException e, HttpServletRequest request) {
        ...
        ErrorMessage em = ErrorMessage.builder()
                ...
                .build()
                ;
        return  new ResponseEntity<ErrorMessage>(em, HttpStatus.FORBIDDEN);
    }

    @ExceptionHandler(value = { GlobalException.class })
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    @ResponseBody
    protected ResponseEntity<ErrorMessage> handleConflict(GlobalException e, HttpServletRequest request) {
